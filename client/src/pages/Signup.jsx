...
export default function Signup() {
  return (
    <>
        ...
        <form className='inter-f5 w-full flex flex-col gap-2'>
            ...
            <div class="flex items-center mt-[14px]">
                ...
                />
                <label class="ms-2 inter-f5">I Agree with <span className='inter-f6' style={{fontSize:'14px', lineHeight:'20px',color:'#FE8C00'}}>Terms of Service</span> and <span className='inter-f6' style={{fontSize:'14px', lineHeight:'20px',color:'#FE8C00'}}>Privacy Policy</span></label>
            </div>
        </form>

        <button className='w-full h-[52px] mt-6 md:mt-3 rounded-[100px] p-4 text-white' style={{backgroundColor:'#FE8C00'}}>Register</button>
        ...
        <div className='w-full mt-6'>
            <h2 className='inter-f5 h-[24px] text-center'>Have an account? <span className='inter-f6' style={{fontSize:'14px', lineHeight:'20px',color:'#FE8C00'}}>Sign In</span></h2>
        </div>
